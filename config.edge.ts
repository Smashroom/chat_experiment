...
export const appConfig: AppConfig = {
  ...
  OPENAI_API_KEY: "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" //Deno.env.get("OPENAI_API_KEY") ?? "",
...
Respond with valid markdown. Put activities names in bold. Knowledge cutoff September 2021.
